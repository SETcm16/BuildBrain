...
public class ScreenPoryadokPorazh implements Screen {
    BuildBrain bb;
    ...
    public ScreenPoryadokPorazh(BuildBrain buildBrain) {
        bb = buildBrain;

        imgPorazh = new Texture("foni/porazhPoryadok.png");
    ...
    public void render(float delta) {
        ...
        bb.batch.begin();
        bb.batch.draw(imgPorazh, 0, 0, SCR_WIDTH, SCR_HEIGHT);
